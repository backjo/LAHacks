...
app.get('/leaderboard', passportConf.isAuthenticated, userController.getLeaderboard);
app.get('/achievements', passportConf.isAuthenticated, userController.getAchievements);
